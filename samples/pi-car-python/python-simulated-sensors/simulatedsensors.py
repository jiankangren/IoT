...
# CUSTOM SETTINGS BY OLIVER
SLEEP_IN_SECONDS = 10
MYDEVICEID = "pythondevice002"
...
MSG_TXT = "{\"deviceId\": \"" + MYDEVICEID + "\",\"windSpeed\": %.2f,\"temperature\": %.2f,\"humidity\": %.2f}"
...
def iothub_client_init():
    ...
    print "The connection string: %s " % CONNECTION_STRING
